 ...
 */
public class SerializableModelForBigram implements Serializable {
    ...
    public SerializableModelForBigram(Map<String, Integer> frequencyTable, Map<String, ArrayList<String>> segmentations, Map<String, HashMap<String, Integer>> bigramTable) {
    ...
    public SerializableModelForBigram(HashMap<String, HashMap<String, Integer>> singleTrieArg) {
