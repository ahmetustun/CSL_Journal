...
public class Gibbs_RecursiveInference {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Gibbs_RecursiveInference i = new Gibbs_RecursiveInference(args[0], args[1], Integer.parseInt(args[2]), Integer.parseInt(args[3]),
                ...
                Integer.parseInt(args[5]), Double.parseDouble(args[6]), Double.parseDouble(args[7]), args[8], Double.parseDouble(args[9]), "ml");
    ...
    public Gibbs_RecursiveInference(String outputDir, String wordListDir,
        ...
        featuresBooleanList[0] = false;
        featuresBooleanList[1] = true;
        featuresBooleanList[2] = false;
        featuresBooleanList[3] = false;
    }
    ...
    private String recursiveSplit(Sample sample, String word) {
        ...
        for (int i = 0; i < possibleSplits.size(); i++) {
            ...
            if (bayes.equalsIgnoreCase("ml")) {
                dpScore = calculateBigramLikelihoods(possibleSplits.get(i));
            } else if (bayes.equalsIgnoreCase("dp")) {
                dpScore = calculateBigramLikelihoodsWithDP(possibleSplits.get(i));
            } else if (bayes.equalsIgnoreCase("py")) {
                dpScore = calculateBigramLikelihoodsWithPY(possibleSplits.get(i));
            }
    ...
    public void saveModel() throws IOException {
        ...
        SerializableModelForBigram model = new SerializableModelForBigram(frequencyTable, segmentationsList, bigramFreq);
