 ...
 */
public class SegmentationGeneratorForBigram {
    ...
    public SegmentationGeneratorForBigram(String vectorDir, String file, String inputFile, String mode, int thresholdArg) throws IOException, ClassNotFoundException {
...
/*        int[] thresholdSet = {50};
        ...
        SegmentationGeneratorForBigram s = new SegmentationGeneratorForBigram(args[0], args[1], args[2], args[3], Integer.parseInt(args[4]));
    }
    ...
    public void deSerialize(String file) throws IOException, ClassNotFoundException {
        ...
        SerializableModelForBigram model = (SerializableModelForBigram) o;
